...
public class Product {
	...
	public Product(String name, String brand, String description, double unitPrice, int quantity,
			int categoryId, boolean active, int supplierId, int purchases, int views) {
		super();
		this.code = "PRD" + UUID.randomUUID().toString().substring(26).toUpperCase();
		this.name = name;
		this.brand = brand;
